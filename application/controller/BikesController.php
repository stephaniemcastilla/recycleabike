...
class BikesController extends Controller
{
    ...
    public function update()
    {
        ...
        BikesModel::updateBike(Request::post('uuid'), $number, Request::post('make'), Request::post('model'), Request::post('color'), Request::post('price'), Request::post('serial'), $target_file, Request::post('source'), Request::post('status'), Request::post('mechanic'), Request::post('date_in'), Request::post('date_out'));
        Redirect::to('bikes');
    }
