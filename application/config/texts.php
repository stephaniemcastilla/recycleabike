...
return array(
  ...
  "FEEDBACK_AVATAR_IMAGE_DELETE_FAILED" => "Something went wrong while deleting your avatar.",
	...
	"FEEDBACK_TIMESHEET_CREATION_FAILED" => "Timesheet creation failed.",
	"FEEDBACK_TIMESHEET_EDITING_FAILED" => "Timesheet editing failed.",
	"FEEDBACK_TIMESHEET_DELETION_FAILED" => "Timesheet deletion failed.",
	"FEEDBACK_PERSON_TIME_EDITING_FAILED" => "Person time editing failed.",
	"FEEDBACK_PERSON_POINTS_EDITING_FAILED" => "Person points editing failed.",
